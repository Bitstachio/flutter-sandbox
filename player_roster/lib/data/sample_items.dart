...
const List<Item> sampleItems = [
  Item(
    ...
    thumbUrl: 'assets/images/thumb_robert_sanchez.png',
    imageUrl: 'assets/images/img_robert_sanchez.jpg',
    description:
  ...
  Item(
    ...
    thumbUrl: 'assets/images/thumb_marc_cucurella.png',
    imageUrl: 'assets/images/img_marc_cucurella.jpg',
    description:
        'Left Back. Marc Cucurella is a tireless and energetic left-back known for his overlapping runs, pressing intensity, and quick transitions from defense to attack. Having started his career at Barcelona’s famed La Masia academy, he rose through La Liga before moving to Brighton and later Chelsea in 2022. Cucurella’s versatility allows him to operate both as a traditional full-back and as part of a back three, bringing flexibility and dynamism to Chelsea’s defensive setup.',
  ),
  Item(
    title: 'Tosin Adarabioyo',
    thumbUrl: 'assets/images/thumb_tosin_adarabioyo.png',
    imageUrl: 'assets/images/img_tosin_adarabioyo.jpg',
    description:
        'Centre-Back. Tosin Adarabioyo is an intelligent, composed English centre-back who combines strong aerial dominance with impressive ball-playing ability. A Manchester City academy graduate, Tosin joined Chelsea from Fulham in 2023, where his consistent performances in the Premier League earned widespread recognition. His height and composure make him an asset both defensively and in building play from the back, embodying the modern defender’s skill set.',
  ),
  Item(
    title: 'Benoît Badiashile',
    thumbUrl: 'assets/images/thumb_benoit_badiashile.png',
    imageUrl: 'assets/images/img_benoit_badiashile.jpg',
    description:
        'Centre-Back. Benoît Badiashile is a technically adept French defender who brings balance, calmness, and strong positional sense to Chelsea’s backline. Having emerged from AS Monaco’s youth system, he joined Chelsea in 2023 as one of Europe’s most promising young defenders. His ability to read the game and distribute accurately under pressure allows Chelsea to play fluidly from deep positions. Badiashile’s physical presence and tactical awareness make him a mainstay in both domestic and European fixtures.',
  ),
  Item(
    title: 'Levi Colwill',
    thumbUrl: 'assets/images/thumb_levi_colwill.png',
    imageUrl: 'assets/images/img_levi_colwill.jpg',
    description:
        'Centre-Back. Levi Colwill is a highly regarded English centre-back who embodies the modern defensive archetype: strong, composed, and progressive in possession. A product of Chelsea’s academy, Colwill’s maturity beyond his years has earned him regular first-team opportunities and international attention. Known for his intelligent positioning and left-footed balance in defense, he plays a crucial role in building attacks from the back while maintaining defensive solidity.',
  ),
  Item(
    title: 'Jorrel Hato',
    thumbUrl: 'assets/images/thumb_jorrel_hato.png',
    imageUrl: 'assets/images/img_jorrel_hato.jpg',
    description:
        'Left Back. Jorrel Hato is a dynamic Dutch full-back who blends defensive strength with attacking flair. Having made a name for himself at Ajax, his move to Chelsea in 2025 marked a major step in his young career. Hato’s pace and composure allow him to track back quickly while contributing to overlapping attacking sequences. His versatility enables him to play as a centre-back or left-back, making him one of Europe’s most exciting young defenders.',
  ),
  Item(
    title: 'Reece James',
    thumbUrl: 'assets/images/thumb_reece_james.png',
    imageUrl: 'assets/images/img_reece_james.jpg',
    description:
        'Right Back. Reece James, Chelsea’s captain and academy graduate, is widely regarded as one of the Premier League’s most complete right-backs. Renowned for his physical power, precise crossing, and tactical awareness, James contributes both defensively and offensively. His leadership on and off the pitch has made him an influential figure at Stamford Bridge. When fit, James provides width, creativity, and defensive resilience, embodying Chelsea’s tradition of strong homegrown talent.',
  ),
  Item(
    title: 'Moisés Caicedo',
    thumbUrl: 'assets/images/thumb_moises_caicedo.png',
    imageUrl: 'assets/images/img_moises_caicedo.jpg',
    description:
        'Defensive Midfielder. Moisés Caicedo is a high-energy Ecuadorian midfielder known for his relentless work rate, tactical intelligence, and ball-winning ability. After impressing at Brighton, he joined Chelsea in 2023 for a record transfer fee, quickly establishing himself as a key defensive shield in midfield. Caicedo’s blend of tenacity and technical ability makes him vital in controlling transitions and breaking opposition lines, anchoring Chelsea’s midfield with remarkable consistency.',
  ),
  Item(
    title: 'Enzo Fernández',
    thumbUrl: 'assets/images/thumb_enzo_fernandez.png',
    imageUrl: 'assets/images/img_enzo_fernandez.jpg',
    description:
        'Central Midfielder. Enzo Fernández is an Argentine midfield maestro recognized for his exceptional vision, passing range, and creativity. After winning the 2022 FIFA World Cup with Argentina and earning the tournament’s Best Young Player award, he joined Chelsea from Benfica in 2023. Enzo thrives as a deep-lying playmaker, orchestrating attacks and dictating tempo. His intelligence, composure, and leadership continue to make him one of Chelsea’s most technically gifted players.',
  ),
  Item(
    title: 'Andrey Santos',
    thumbUrl: 'assets/images/thumb_andrey_santos.png',
    imageUrl: 'assets/images/img_andrey_santos.jpg',
    description:
        'Central Midfielder. Andrey Santos is a promising Brazilian box-to-box midfielder who brings energy, vision, and attacking drive. Joining Chelsea from Vasco da Gama in 2023, Santos has quickly adapted to the pace of European football. His strong tackling, forward runs, and eye for goal make him a balanced midfielder capable of contributing at both ends of the pitch. Seen as a long-term project, Santos represents the next generation of Brazilian talent.',
  ),
  Item(
    title: 'Cole Palmer',
    thumbUrl: 'assets/images/thumb_cole_palmer.png',
    imageUrl: 'assets/images/img_cole_palmer.jpg',
    description:
  ...
  Item(
    title: 'Estêvão',
    thumbUrl: 'assets/images/thumb_estevao.png',
    imageUrl: 'assets/images/img_estevao.jpg',
    description:
